...
INSERT INTO `log_evento` VALUES (1,'teste','2025-04-14 07:58:04'),(2,'teste','2025-04-14 07:58:11');
...
BEGIN
    ...
    -- Calculando a soma do preço * quantidade de ingressos vendidos para o evento específico
    SELECT SUM(i.preco * ic.quantidade) INTO total_renda
    FROM ingresso_compra ic
    JOIN ingresso i ON i.id_ingresso = ic.fk_id_ingresso
    WHERE i.fk_id_evento = id_evento; -- Relaciona o ingresso ao evento específico

    -- Retorna o total arrecadado ou 0 se não houver vendas
...
-- Dump completed on 2025-04-14 15:57:29
